{
    ...
    /* 
        ===========================================================================
        Inspiration and guidance from Chris Miller:  https://github.com/camilleryr
        ===========================================================================
...
mineralOrder.forEach(function (mineral) {
    ...
    let order;
    while (order = mineHeapSkopeManager.process(mineral).next().value) {
        /* 
        1. Get the order
...
console.log("myHeapSkope2: ", mineHeapSkopeContainers);
